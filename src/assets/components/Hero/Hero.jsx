...
import { SiReact, SiJavascript, SiTailwindcss, SiBootstrap, SiLaravel, SiPhp, SiGit, SiFirebase } from "react-icons/si";
...
<div className="flex gap-3 md:gap-10 text-3xl text-zinc-100 bg-zinc-600 rounded-full p-4 md:px-6">
      ...
      <SiFirebase className="" />
        ...
        <p className="mt-4 px-3 md:px-50  text-lg text-zinc-700">
          Desarrolladora Full Stack Jr buscando aportar soluciones creativas y eficientes para la digitalización de empresas por medio de páginas/aplicaciones web completas. Abierta a aportar con mi trabajo a causas que impacten positivamente en la sociedad.
